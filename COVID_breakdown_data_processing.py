...
class MainSheet(Template):
  ...
  def getSymptom(self):
    key_dict = {
      ...
      'fever': ['微燒(37.5度)', '體溫偏高(37.4度)', '發燒(耳溫量測37.7度)', '自覺有發燒', '自覺發燒', '輕微發燒', '間歇性發燒', 
                '身體微熱', '體溫偏高', '自覺發熱', '身體悶熱不適', '微燒', '發燒', '發熱', '盜汗'],
      ...
      'headache': ['輕微頭痛', '輕度頭痛', '頭骨痛', '頭痛', '頭暈', '頭脹', '暈眩'],
      ...
      'soreness': ['全身肌肉痠痛', '上半身骨頭刺痛', '全身痠痛', '小腿肌肉痠痛', '肌肉痠痛症狀', '肌肉關節痠痛', '肌肉酸痛', '肌肉痠痛', '肌肉 痠痛', 
                   '肌肉痛', '骨頭痠痛', '骨頭酸', '關節痠痛', '關節痛', '身體痛', '痠痛'],
      'hypersomnia': ['嗜睡'],
      'insomnia': ['睡不著'], 
