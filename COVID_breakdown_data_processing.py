...
class MainSheet(Template):
  ...
  def getOnsetDate(self):
    ...
    for i, onset_date in enumerate(self.getCol(self.coltag_onset_date)):
      if onset_date != onset_date: ## NaN
        ...
        '5/14-22', '5/14-29', '5/15-26', '5/15-6/4', '5/20-30', '5/20-31', '5/18-6/2', '5/24-6/5',
        '6/1-2', 
  ...
  def getSymptom(self):
    key_dict = {
      ...
      'fatigue': [
        '全身倦怠無力', '左側肢體無力', '全身倦怠', '全身疲憊', '身體無力', '全身無力', '四肢無力', '精神倦怠', '體力不支', '全身虛弱', 
  ...
  def getLink(self):
    ...
    for i, link in enumerate(self.getCol(self.coltag_link)):
      if link == '未知':
        ...
        '遠傳案', '京元電', 
        '養護中心', '朝陽夜唱', '金沙酒店', '金樽喜宴', '泰安附幼', '成功市場', '洗腎診所', '長照機構', 
