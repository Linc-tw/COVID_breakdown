...
class MainSheet(Template):
  ...
  def getOnsetDate(self):
    ...
    for i, onset_date in enumerate(self.getCol(self.coltag_onset_date)):
      if onset_date != onset_date: ## NaN
        ...
        '5/13-25', '5/13-27', '5/14-29', '5/15-26', '5/20-30', '5/20-31', 
  ...
  def getSymptom(self):
    key_dict = {
      ...
      'earache': [' 耳朵痛'],
      'dyspnea': ['活動後呼吸喘', '呼吸不順', '呼吸困難', '呼吸微喘', '呼吸短促', '呼吸急促', '走路會喘', '走路喘', '呼吸喘', '輕微喘', '微喘', '氣喘', '喘嗚', '喘'],
      'bronchitis': ['支氣管炎'],
      ...
      'headache': ['頭暈目眩', '輕度頭痛', '頭骨痛', '頭痛', '頭暈', '頭脹', '暈眩'],
      ...
      'hypoglycemia': ['低血糖'],
      'anorexia': ['食慾不佳', '食慾不振', '胃口變差', '食慾差', '無食慾'],
      'arrhythmia': ['心律不整'],
      'coma': ['意識不清', '意識改變'],
