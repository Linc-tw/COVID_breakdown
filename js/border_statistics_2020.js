...
$(document).on("change", "input:radio[name='" + BS_2020_wrap.tag + "_exit']", function (event) {
  var old_btn = document.getElementById(BS_2020_wrap.tag + '_exit_' + BS_2020_wrap.do_exit);
  var new_btn = document.getElementById(BS_2020_wrap.tag + '_exit_' + this.value);
