...
$(document).on("change", "input:radio[name='" + ASC_2020_wrap.tag + "_count']", function (event) {
  var old_btn = document.getElementById(ASC_2020_wrap.tag + '_count_' + ASC_2020_wrap.do_count);
  var new_btn = document.getElementById(ASC_2020_wrap.tag + '_count_' + this.value);
