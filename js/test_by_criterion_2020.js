...
//-- Variables
TBC_2020_wrap.do_cumul = document.querySelector("input[name='" + TBC_2020_wrap.tag + "_cumul']:checked").value;
...
//-- Buttons
GS_PressRadioButton(TBC_2020_wrap, 'cumul', 0, TBC_2020_wrap.do_cumul); //-- 0 from .html

$(document).on("change", "input:radio[name='" + TBC_2020_wrap.tag + "_cumul']", function (event) {
  GS_PressRadioButton(TBC_2020_wrap, 'cumul', TBC_2020_wrap.do_cumul, this.value);
